# cescp-day4
Day 4 CESCP
he prototype now covers all five stops from Day 4, each built on the same interactive pattern:

- **TLS** — encrypt-or-not on the wire
- **MQTT** — broker auth blocking a rogue publish
- **CAN** — message authentication rejecting a forged brake frame
...
Want this saved as a .md file in the project?

Access [(https://myramade.github.io/cescp-day4)]
